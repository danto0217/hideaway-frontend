...
export const nftSources: NftSource = {
  ...
  [NftType.MINT]: {
    address: {
      ...
      97: '0xab6cEEaC2a56A51E2862AFF14BF81f5E1773a089',
    },
...
const Nfts: Nft[] = [
  ...
  {
    name: 'Churro',
    description: "Don't let that dopey smile deceive you... Churro's a master CLIP chef!",
    images: {
      lg: 'churro-lg.png',
      md: 'churro-md.png',
      sm: 'churro-sm.png',
  ...
  {
    name: 'Dollop',
    description: "Nommm... Oh hi, I'm just meditating on the meaning of CLIP.",
    images: {
      lg: 'dollop-lg.png',
      md: 'dollop-md.png',
      sm: 'dollop-sm.png',
  ...
  {
    name: 'Twinkle',
    description: "Three guesses what's put that twinkle in those eyes! (Hint: it's CLIP)",
    images: {
      lg: 'twinkle-lg.png',
      md: 'twinkle-md.png',
      sm: 'twinkle-sm.png',
